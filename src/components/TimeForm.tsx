            ...
            <div className="row">
                <div style={{borderRadius:"20px"}}className="card center-align red">
                    <div className="card-content">
                        ...
                        <form>
                            <div className="row">
                                <div style={{borderRadius:"20px", width:"50%", display:"flex", justifyContent:"center", padding:"10px"}} className="card-panel col red accent-2">
                                ...
                                <div style={{borderRadius:"20px", width:"50%", display:"flex", justifyContent:"right", padding:"10px"}} className="card-panel col red accent-2">
                            ...
                            <div className="row">
                                <div style={{borderRadius:"20px", margin:"auto", width:"50%", display:"flex", justifyContent:"left", padding:"10px"}} className="card-panel col s6 red accent-2">
                                ...
                                <div style={{borderRadius:"20px", margin:"auto", width:"50%", display:"flex", justifyContent:"right", padding:"10px"}} className="card-panel col s6 red accent-2">
